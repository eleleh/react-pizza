...
export const list: ListItem[] = [
  { name: "Beliebt (DESC)", sortProperty: SortPropertyEnum.RATING_DESC },
  { name: "Beliebt (ASC)", sortProperty: SortPropertyEnum.RATING_ASC },
  { name: "Preis (DESC)", sortProperty: SortPropertyEnum.PRICE_DESC },
  { name: "Preis (ASC)", sortProperty: SortPropertyEnum.PRICE_ASC },
...
export const SortPopup: React.FC<SortPopupProps> = React.memo(
  ({ sortValue }) => {
    ...
    const sortName = useSelector(selectFilter).sort.name;
